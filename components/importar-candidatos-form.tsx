...
const ALIASES: Record<string, keyof LinhaImportacao> = {
  ...
  funcao: "cargo",
  estrutura: "estrutura",
  "letra da cnh": "categoriaCnh",
  "letra cnh": "categoriaCnh",
...
const COLUNAS_POR_TIPO: Record<TipoPessoa, { campo: keyof LinhaImportacao; label: string }[]> = {
  interno: [
    ...
    { campo: "estrutura", label: "Estrutura" },
    { campo: "categoriaCnh", label: "Letra da CNH" },
...
export function ImportarCandidatosForm() {
  ...
  function confirmarImportacao() {
    const payload: LinhaImportacao[] = linhas.map((l) => ({
      ...
      nome: l.dados.nome ?? "",
      cargo: l.dados.cargo,
      estrutura: l.dados.estrutura,
      cpf: l.dados.cpf,
      categoriaCnh: l.dados.categoriaCnh,
